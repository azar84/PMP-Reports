...
async function GET(request) {
    try {
        const users = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].adminUser.findMany({
            select: {
                id: true,
                username: true,
                email: true,
...
async function POST(request) {
    try {
        ...
        const existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].adminUser.findFirst({
            where: {
                OR: [
                    {
                        username
        ...
        // Create user
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].adminUser.create({
            data: {
                username,
                email,
                passwordHash,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b5f19c4a._.js.map