...
"[project]/src/hooks/useSiteSettings.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function formatCurrencyWithDecimals(amount, currencySymbol = '$', decimals = 2, locale = 'en-US') {
    if (amount === null || amount === undefined || isNaN(amount)) {
...
function parseCurrency(currencyString, currencySymbol = '$') {
    if (!currencyString) return 0;
    // Remove currency symbol and any non-numeric characters except decimal point and commas
    const cleaned = currencyString.replace(new RegExp(`\\${currencySymbol}`, 'g'), '').replace(/[^\d.,]/g, '');
...
//# sourceMappingURL=src_4afd3c71._.js.map